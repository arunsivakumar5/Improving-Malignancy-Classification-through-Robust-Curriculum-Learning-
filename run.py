...
if method =='ERM':
    ...
    if args.curriculum == 'Both':
        ...
        for i in range(1,args.trials + 1): 
            ...
            modelA,max_acc = train_erm_ct(params,train_dataloader1,val_dataloader,train_dataloader2,model,num_epochs=50,mode='cur_erm')
            ...
            modelA,max_acc = train_erm(params,train_dataloader,val_dataloader,model,num_epochs=50,mode='erm')
