...
if method =='ERM':
    ...
    if args.curriculum == 'Both':
        ...
        for i in range(1,args.trials + 1): 
            ...
            modelA,max_acc = train_gdro_ct(params,model,train_dataloader1,val_dataloader1,train_dataloader2,val_dataloader2,num_epochs=100,mode='cur_gDRO',subclass_counts1=subclass_counts1,subclass_counts2=subclass_counts2)
            ...
            modelA,max_acc = train_gdro(params,model,train_dataloader,val_dataloader,num_epochs=100,mode ='gDRO',subclass_counts = subclass_counts)
